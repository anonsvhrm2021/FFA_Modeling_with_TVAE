...
def eval_classification_epoch_many_imagenet(model, criterion,
    ...
    if plot_class_selectivity:
        # Plot_ClassActMap_SNS(all_fc6, all_labels, os.path.join(savepath, 'samples'), epoch, wandb_on=wandb_on, name='Class_Selectivity_FC6')
        # Plot_ClassActMap_SNS_Continuous(all_fc6, all_labels, os.path.join(savepath, 'samples'), epoch, wandb_on=wandb_on, name='Class_Selectivity_Cont_FC6')

        # Plot_ClassActMap_SNS(all_fc7, all_labels, os.path.join(savepath, 'samples'), epoch, wandb_on=wandb_on, name='Class_Selectivity_FC7')
        # Plot_ClassActMap_SNS_Continuous(all_fc7, all_labels, os.path.join(savepath, 'samples'), epoch, wandb_on=wandb_on, name='Class_Selectivity_Cont_FC7')
        ...
        selectivity_maps = Plot_ClassActMap_SNS_MultiColor(all_fc7, all_labels,  os.path.join(savepath, 'samples'), epoch, 
                                        colors=colors, class_names=class_names, 
                                        thresh=0.7, wandb_on=True, name='Class_Selectivity_FC7')
        ...
        selectivity_maps = Plot_ClassActMap_SNS_MultiColor(all_fc6, all_labels,  os.path.join(savepath, 'samples'), epoch, 
                                        colors=colors, class_names=class_names, 
                                        thresh=0.7, wandb_on=True, name='Class_Selectivity_FC6')
